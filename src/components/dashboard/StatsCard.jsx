...
export default function StatsCard({ title, value, icon: Icon, change, color }) {
  ...
  const colorMap = {
    primary: {
      ...
      text: 'text-[#3B5CCC] dark:text-[#6C8DFF]',
      ...
      gradient: 'from-[#3B5CCC] to-[#5E81F4] dark:from-[#6C8DFF] dark:to-[#9EB4FF]',
    },
    success: {
      bg: 'bg-[#22C55E]/10 dark:bg-[#4ADE80]/10',
      text: 'text-[#22C55E] dark:text-[#4ADE80]',
      border: 'border-[#22C55E]/10 dark:border-[#4ADE80]/20',
      hoverGlow: 'group-hover:border-[#22C55E]/30 dark:group-hover:border-[#4ADE80]/40',
      gradient: 'from-[#22C55E] to-teal-500 dark:from-[#4ADE80] dark:to-teal-400',
    },
    warning: {
      bg: 'bg-[#FF8F5A]/10 dark:bg-[#FFA26E]/10',
      text: 'text-[#FF8F5A] dark:text-[#FFA26E]',
      border: 'border-[#FF8F5A]/10 dark:border-[#FFA26E]/20',
      hoverGlow: 'group-hover:border-[#FF8F5A]/30 dark:group-hover:border-[#FFA26E]/40',
      gradient: 'from-[#FF8F5A] to-amber-500 dark:from-[#FFA26E] dark:to-amber-400',
    },
    danger: {
      bg: 'bg-[#EF4444]/10 dark:bg-[#F87171]/10',
      text: 'text-[#EF4444] dark:text-[#F87171]',
      border: 'border-[#EF4444]/10 dark:border-[#F87171]/20',
      hoverGlow: 'group-hover:border-[#EF4444]/30 dark:group-hover:border-[#F87171]/40',
      gradient: 'from-[#EF4444] to-red-600 dark:from-[#F87171] dark:to-red-500',
    },
  };
