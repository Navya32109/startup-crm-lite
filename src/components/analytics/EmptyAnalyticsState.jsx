...
export default function EmptyAnalyticsState() {
  ...
  return (
    <div className="bg-white dark:bg-[#13151d] border border-slate-200 dark:border-slate-800 rounded-2xl p-12 text-center shadow-sm select-none max-w-xl mx-auto my-12 animate-fade-in">
      ...
      <h3 className="font-display font-bold text-slate-900 dark:text-white text-lg mb-1">
