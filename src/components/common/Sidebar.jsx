...
export default function Sidebar({ setIsSearchOpen }) {
  ...
  return (
    <>
      ...
      <aside 
        className="hidden md:flex flex-col border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all duration-300 relative z-30 md:w-24 lg:w-64 shrink-0"
      >
        {/* Brand/Logo Segment */}
        <div className="p-6 flex items-center justify-center lg:justify-start gap-3 shrink-0">
          ...
          <span className="font-display font-bold text-lg tracking-tight bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent hidden lg:inline-block">
        ...
        <div className="px-4 mb-4 flex justify-center lg:block shrink-0">
          <button 
            ...
            className="p-2 lg:p-0 text-gray-400 hover:text-gray-650 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700/50 rounded-lg cursor-pointer lg:w-full lg:flex lg:items-center lg:gap-2 lg:px-3 lg:py-2 lg:text-sm lg:text-gray-400 lg:dark:text-gray-500 lg:bg-gray-50 lg:dark:bg-gray-900 lg:border lg:border-gray-200 lg:dark:border-gray-700 lg:rounded-lg lg:hover:border-gray-300 lg:dark:hover:border-gray-600 lg:transition-all lg:text-left flex items-center justify-center"
            title="Search leads (Ctrl+K)"
          >
            <Search size={16} className="lg:size-3.5 shrink-0" />
            <span className="hidden lg:inline flex-1 text-xs text-gray-400 dark:text-gray-500 ml-1.5">Search...</span>
            <kbd className="hidden lg:inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-mono text-gray-400 dark:text-gray-500 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-sm shrink-0">
              <Command size={8} /> K
            </kbd>
          </button>
        </div>
                ...
                className={({ isActive }) => 
                  `flex flex-col lg:flex-row items-center gap-1 lg:gap-3 p-3 lg:px-4 lg:py-3 rounded-xl text-xs font-medium transition-all group relative cursor-pointer ${
                    isActive 
                      ...
                      : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-900/40'
                  }`
                }
              >
                {({ isActive }) => (
                  <>
                    <Icon size={20} className={`shrink-0 ${isActive ? 'text-blue-600 dark:text-blue-400' : 'text-gray-450 dark:text-gray-500 group-hover:text-gray-650 dark:group-hover:text-gray-300'}`} />
                    ...
                    <div className="flex flex-col items-center lg:items-start min-w-0">
                      ...
                      <span className="hidden lg:inline text-[10px] text-gray-400 dark:text-gray-500 font-normal mt-0.5 truncate max-w-full leading-tight">
                        {item.subLabel}
                      </span>
                    </div>
                    
                    {item.badge ? (
                      <span className="absolute top-1.5 right-1.5 lg:static lg:top-auto lg:right-auto lg:ml-auto bg-blue-100 dark:bg-blue-900/40 text-blue-750 dark:text-blue-305 text-[8px] lg:text-[10px] px-1.5 py-0.5 rounded-full font-bold border border-blue-200/50 dark:border-blue-800/40 shrink-0">
                        {item.badge}
                      </span>
                    ) : null}
                  </>
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-700 space-y-2.5 shrink-0">
          {/* Tablet view: compact icon-only switch, Desktop view: full DarkModeToggle */}
          <div className="block lg:hidden select-none">
            <button 
              onClick={toggleTheme}
              className="w-12 h-12 mx-auto flex items-center justify-center rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-550 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all cursor-pointer"
              title="Toggle theme"
            >
          ...
          <div className="relative" ref={profileDropdownRef}>
            <button 
              ...
              className="w-full flex flex-col lg:flex-row items-center gap-1.5 lg:gap-3 p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-900/40 transition-all text-left cursor-pointer"
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white/80 dark:bg-gray-800/85 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 px-4 flex items-center justify-between z-40">
        <div className="flex items-center gap-3">
          ...
          <span className="font-display font-bold text-base bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
            CRM<span className="text-blue-600">Lite</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <button 
            onClick={() => setIsSearchOpen(true)}
            className="w-11 h-11 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-105 dark:hover:bg-gray-700/60 rounded-lg cursor-pointer"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-white/90 dark:bg-gray-800/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-700 px-6 flex items-center justify-around z-40">
        {navItems.map((item) => {
          const Icon = item.icon;
          return (
            <NavLink
            ...
            >
              {({ isActive }) => (
                <div className="relative">
                  <Icon size={22} className={isActive ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-gray-550'} />
                  {item.badge ? (
                    <span className="absolute -top-1 -right-1.5 bg-blue-600 text-white text-[8px] font-bold h-4 w-4 rounded-full flex items-center justify-center border border-white dark:border-gray-800">
                      {item.badge}
                    </span>
                  ) : null}
                </div>
      ...
      {isMobileOpen && (
        <div className="md:hidden fixed inset-0 z-50 flex">
          ...
          <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm" onClick={() => setIsMobileOpen(false)}></div>
          
          {/* Sliding drawer navigation layout panel */}
          <aside className="relative flex flex-col w-72 max-w-[80vw] bg-white dark:bg-gray-800 h-full shadow-2xl p-5 border-r border-gray-200 dark:border-gray-700 animate-slide-in">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="font-display font-bold text-base text-gray-900 dark:text-white">CRM<span className="text-blue-600">Lite</span></span>
              </div>
              {/* Drawer Close Button with 44x44px target */}
              <button 
                onClick={() => setIsMobileOpen(false)}
                className="w-11 h-11 flex items-center justify-center text-gray-400 hover:text-gray-650 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full cursor-pointer"
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) => 
                      `flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all cursor-pointer ${
                        isActive 
                          ? 'bg-blue-50/70 dark:bg-blue-950/20 text-blue-600 dark:text-blue-400' 
                          : 'text-gray-500 dark:text-gray-405 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-900/40'
                      }`
                    }
                  >
                    <Icon size={18} />
                    <div className="flex flex-col min-w-0 flex-1">
                      ...
                      <span className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5 truncate">{item.subLabel}</span>
                    </div>
                    {item.badge && (
                      <span className="bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-305 text-[10px] px-1.5 py-0.5 rounded-full font-bold">
                        {item.badge}
                      </span>
                    )}
                  </NavLink>
